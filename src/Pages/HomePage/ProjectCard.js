    ...
    return (
        <div className="flex flex-row flex-wrap justify-center items-center">
            <div className="font-['Rajdhani'] text-[250px] opacity-10 font-thin z-10">{props.number}</div>
                <div className="z-0 w-[250px] h-[300px] shadow rounded-2xl bg-[#FFF2F2] dark:bg-[#F9F9F9] transition-all ease-in-out duration-[2000ms] m-3 flex flex-col">
                    {isClicked1 ?
                    ...
                    :<div className=" flex flex-col z-20">
                        <div className="mt-10 w-5/6 text-left flex self-center text-3xl">{props.title}</div>
                        <div className=" text-left w-5/6 flex self-center mt-2">{props.text}</div>
