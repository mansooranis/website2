            ...
            <Navbar expand="md" variant="light" bg="light" fixed="top" className="nav" scrolling >
                ...
                <Navbar.Toggle aria-controls="basic-navbar-nav" />
                    <Navbar.Collapse className="justify-content-end">
                        ...
                        <Nav.Link download="MansoorAnis.pdf" href="https://drive.google.com/file/d/18Xn1xmjJ60GZVfRpyFI8SPf9KCPT0mEV/view?usp=sharing" style={{color:"black"}}>Resume</Nav.Link>
